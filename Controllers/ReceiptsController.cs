    ...
    public class ReceiptsController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<Receipt>>> GetReceipts()
        {
          if (_context.Receipts == null)
          {
            ...
            return await _context.Receipts.Include(a => a.SoldProducts).ToListAsync();
        }
        ...
        // GET: api/Receipts/day/5
        [HttpGet("day/{dayDate}")]
        public async Task<ActionResult<Receipt>> GetDayReceipts(DateTime dayDate)
        {
            
            var receipts = await _context.Receipts.Where(q => q.DayDate.Date == dayDate.Date).Include(a => a.SoldProducts).ToListAsync(); 
            return Ok(receipts);
        }
    }
}
